    ...
    <div>
      ...
      <div className="min-h-svh h-svh flex flex-col ">
        <div className="lg:ml-[80px] p-5 lg:p-6 flex sm:flex-row flex-col items-end justify-end bg-gradient-to-l from-[#ffd9d98f] space-x-2 space-y-1">
          <a
            href="mailto:maarikaphoto@gmail.com"
            className="flex font-light font-europa tracking-widest items-center space-x-2"
          >
            <svg
        ...
        <div className="w-full max-w-[600px] max-h-[600px] my-auto bg-contactBackground bg-cover bg-center bg-no-repeat  mx-auto flex items-center h-full">
          <form
            onSubmit={sendMail}
            id="myForm"
            className="flex flex-col p-4 w-full h-full items-center justify-center "
          >
            <div className="max-w-[400px] w-full ">
              <h1 className="mb-10 text-xl text-medium text-gray-700 text-center">
                {" "}
              ...
              {sendMessage && (
                <div className="text-green text-[9.5px] lg:text-base font-medium mt-3">
                  {" "}
                  Aitäh!! Sõnum edukalt edasi toimetatud{" "}
                </div>
              )}
            </div>
          </form>
        ...
        <Footer
          className="z-20 w-full text-black justify-between p-4 lg:pr-4 lg:pl-8 py-4"
          color="fill-black hover:fill-[#ffc8d7] hover:scale-125"
        />
      </div>
    </div>
  );
