...
export default function Home() {
  return (
    <div>
      ...
      <section className="w-full h-screen bg-center bg-cover bg-hero">
        <div className="text-white font-light font-europa flex flex-col items-end justify-center h-full max-w-[90%] my-auto mx-auto py-8">
          <div className="flex tracking-widest space-x-3 md:space-x-3 text-sm md:hidden w-full justify-center">
          ...
          <div className="h-full flex flex-col justify-center text-end">
            ...
            <div className="mt-auto text-white flex space-x-2">
              <a href="https://www.instagram.com/maarikakauksiphotography/?hl=en" target="_blank">
              ...
              <a href="https://www.facebook.com/profile.php?id=100083092881002" target="_blank">
