  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="Fotosessioon : 60€, Sisaldab kõiki õnnestunud fotosid digitaalsel kujul"
        />
        <link rel="preload" as="image" href="/images/portfolio/DSC08373.webp" />
      </Head>
      <Header />
      <div className="min-h-svh h-svh flex flex-col bg-cover bg-priceHero bg-[center_90%] text-white p-4 lg:pr-4 lg:pl-8 py-4">
        <div className="flex flex-col justify-center items-center w-full font-europa h-full">
          <div className="flex justify-center items-center w-full lg:w-[500px] lg:h-[150px] w-[300px] h-[100px] bg-[#7b5151ad] border-white border-4 rounded-lg text-3xl lg:text-5xl font-bold tracking-[0.2em]">
            {" "}
            Hinnakiri{" "}
          </div>
          <div className="text-center  mt-10 rounded-xl p-4 lg:p-10 bg-[#7b5151ad]">
            <div className="text-white tracking-widest text-xl sm:text-2xl lg:text-5xl mt-6 font-medium">
              {" "}
              Fotosessioon : 120.-{" "}
            </div>
            <div className="text-xl lg:text-3xl mt-4">
              Sisaldab kõiki õnnestunud fotosid digitaalsel kujul
            </div>
